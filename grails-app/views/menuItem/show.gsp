...
<html>
    ...
    <body>
        ...
        <div id="show-menuItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="menuItem" />
            <g:form resource="${this.menuItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.menuItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
